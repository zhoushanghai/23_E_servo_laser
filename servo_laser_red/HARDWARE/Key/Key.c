...
void key_init(int period)
{
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0 | GPIO_Pin_1 | GPIO_Pin_10 | GPIO_Pin_12;
...
{
	keyVal[0] = GPIO_ReadInputDataBit(GPIOB, GPIO_Pin_3);
	keyVal[1] = GPIO_ReadInputDataBit(GPIOC, GPIO_Pin_12);
	keyVal[2] = GPIO_ReadInputDataBit(GPIOB, GPIO_Pin_5);
	keyVal[3] = GPIO_ReadInputDataBit(GPIOB, GPIO_Pin_7);
	keyVal[4] = GPIO_ReadInputDataBit(GPIOC, GPIO_Pin_10);
	keyVal[5] = GPIO_ReadInputDataBit(GPIOC, GPIO_Pin_1);
	keyVal[6] = GPIO_ReadInputDataBit(GPIOC, GPIO_Pin_0);
}
//(‵▽′)///////////////////////////////////// 应用层 //////////////////////////////////////////////
/*下面是格式*/
