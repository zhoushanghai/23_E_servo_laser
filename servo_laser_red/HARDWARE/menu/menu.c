...
void operation_71_control(void);
...
menu_keyTable menu[MAX_MENU] = {
    ...
    {_6_pro_task4, _5_pro_task3, _7_pro_self, _7_pro_self, _6_pro_task4, (*operation_6_pro_task4)},
         {_7_pro_self, _6_pro_task4, _8_reset_point, _71_control, _7_pro_self, (*operation_7_pro_self)},
    {_71_control, _71_control, _71_control, _71_control, _71_control, (*operation_71_control)},
...
void menu_1(void)
{
    LCD_Color_Fill(0, 0, 240, 240, RED);
    // sprintf(str, "reset");
    LCD_ShowString(1, 1, "reset", BLACK, RED, 16, 0);
    // sprintf(str, "bigsquare");
    LCD_ShowString(1, 20, "bigsquare", BLACK, RED, 16, 0);
    // sprintf(str, "task3");
    LCD_ShowString(1, 40, "task3", BLACK, RED, 16, 0);
    // sprintf(str, "task4");
    LCD_ShowString(1, 60, "task4", BLACK, RED, 16, 0);
    // sprintf(str, "pro_task3");
    LCD_ShowString(1, 80, "pro_task3", BLACK, RED, 16, 0);
    // sprintf(str, "pro_task4");
    LCD_ShowString(1, 100, "pro_task4", BLACK, RED, 16, 0);
    // sprintf(str, "pro_self");
    LCD_ShowString(1, 120, "pro_self", BLACK, RED, 16, 0);

    LCD_ShowString(1, 140, "RES_POINT", BLACK, RED, 16, 0);
}
...
void operation_71_control(void)
{
    ...
    {
        LCD_Color_Fill(0, 0, 240, 240, RED);
        LCD_ShowString(1, 60, "control", BLACK, RED, 32, 0);
    }
    if (key[1].state == KEY_SHORT_PRESS)
    {
        PWM_SetServo1(servo.current_y + 10);
    }
    ...
    {
        PWM_SetServo2(servo.current_x - 10);
    }
    ...
    if (key[1].state == KEY_LONG_PRESS)
    {
        PWM_SetServo1(servo.current_y + 1);
    }
    if (key[2].state == KEY_LONG_PRESS)
    {
        PWM_SetServo1(servo.current_y - 1);
    }
    if (key[3].state == KEY_LONG_PRESS)
    {
        PWM_SetServo2(servo.current_x - 1);
    }
    ...
    if (key[0].state == KEY_LONG_PRESS)
    {
        current_menu = _7_pro_self;
        operation_7_pro_self();
    }
}
...
void operation_1_reset(void)
{
    ...
    if (key[0].state == KEY_SHORT_PRESS)
    {
        ...
        pid.sevor1.output = 0;
        pid.sevor2.output = 0;
        LCD_ShowString(1, 200, "                           ", WHITE, RED, 16, 0);
    }
}
void operation_2_bigsquare(void)
{
...
void operation_3_task3(void)
{
    ...
    if (key[0].state == KEY_SHORT_PRESS)
    {
        LCD_ShowString(1, 200, "task3 is going", WHITE, BLACK, 16, 0);
        PWM_SetServo1(TASK3_y1);
        PWM_SetServo2(TASK3_x1);
        delay_ms(600);
        PWM_SetServo1(TASK3_y2);
        PWM_SetServo2(TASK3_x2);
        delay_ms(600);
        PWM_SetServo1(TASK3_y3);
        PWM_SetServo2(TASK3_x3);
        delay_ms(600);
        PWM_SetServo1(TASK3_y4);
        PWM_SetServo2(TASK3_x4);
        delay_ms(600);
        PWM_SetServo1(TASK3_y1);
        PWM_SetServo2(TASK3_x1);
...
void operation_4_task4(void)
{
    ...
    if (key[0].state == KEY_SHORT_PRESS)
    {
        LCD_ShowString(1, 200, "task4 is going", WHITE, BLACK, 16, 0);
...
void operation_5_pro_task3(void)
{
    ...
    if (key[0].state == KEY_SHORT_PRESS)
    {
        LCD_ShowString(1, 200, "pro_task3 is going", WHITE, BLACK, 16, 0);
        ...
        PWM_SetServo2(dot[0].x);
        delay_ms(1000);
        go_line_set(TASK3_x1, TASK3_y1, TASK3_x2, TASK3_y2, setGO);
        go_line_set(TASK3_x2, TASK3_y2, TASK3_x3, TASK3_y3, setGO);
        go_line_set(TASK3_x3, TASK3_y3, TASK3_x4, TASK3_y4, setGO);
        go_line_set(TASK3_x4, TASK3_y4, TASK3_x1, TASK3_y1, setGO);
...
void operation_6_pro_task4(void)
{
    ...
    if (key[0].state == KEY_SHORT_PRESS)
    {
        LCD_ShowString(1, 200, "pro_task4 is going", WHITE, BLACK, 16, 0);
